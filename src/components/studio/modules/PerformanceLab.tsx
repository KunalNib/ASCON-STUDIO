...
export function PerformanceLab() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center space-y-8 p-6 pb-12">
       ...
       <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-5xl">
         {metrics.map((m, i) => (
           <motion.div 
             ...
             className="bg-black border border-white/5 p-6 rounded-2xl flex flex-col items-center text-center shadow-xl relative overflow-hidden"
           >
       ...
       <div className="w-full max-w-5xl bg-[#09090b] border border-white/5 rounded-3xl p-8 mt-8 flex gap-8 items-center">
          <div className="flex-1 space-y-4">
             <h3 className="text-xl font-bold text-white mb-2">ESP32 Simulation Map</h3>
             <div className="flex flex-col gap-2 font-mono text-xs">
                <div className="flex justify-between items-center text-zinc-400 p-2 bg-black rounded border border-white/5">
                   <span>Flash Memory Overhead</span>
                   <span className="text-zinc-200">~2.4 KB (AES: 14KB)</span>
                </div>
                <div className="flex justify-between items-center text-zinc-400 p-2 bg-black rounded border border-white/5">
                   <span>State Size</span>
                   <span className="text-emerald-400">40 Bytes (Perfect for registers)</span>
                </div>
                <div className="flex justify-between items-center text-zinc-400 p-2 bg-black rounded border border-white/5">
                   <span>Instruction Set Architecture</span>
                   <span className="text-blue-400">Extremely lightweight</span>
                </div>
             </div>
          </div>

          <div className="w-64 h-64 bg-black rounded-full border-4 border-amber-500/20 flex flex-col items-center justify-center p-4 text-center shadow-[0_0_30px_rgba(245,158,11,0.1)] relative">
             ...
             <div className="text-white font-mono mt-1 text-2xl">ACTIVE</div>
          </div>
       </div>
